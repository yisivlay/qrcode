...
/**
 * Holds database server connection details.
 * @author YSivlay
 */
public class PlatformTenantConnection {
    ...
    public PlatformTenantConnection(final Long connectionId, final String schemaName, String schemaServer, final String schemaServerPort, final String schemaUsername, final String schemaPassword,
